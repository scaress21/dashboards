...
museum_types = ['Arboretum, Botanical Garden, or Nature Center', 'Art Museum', 'Childrens Museum', 'General Museum', 'Historic Preservation', 'History Museum', 'Natual History Museum', 'Science and Technology Museum or Planetarium', 'Zoo, Aquarium, or Wildlife Conservation' ]
